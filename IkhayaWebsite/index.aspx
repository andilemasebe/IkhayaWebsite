<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="IkhayaWebsite.Ikhaya" %>
...
.bgimg-2 {
    background-image: url("https://images.unsplash.com/photo-1416339442236-8ceb164046f8?dpr=1&auto=format&crop=entropy&fit=crop&w=1199&h=867&q=80");
    min-height: 400px;
...
<%--      <img src="https://www.w3schools.com/howto/img_link_tree_template2_bio.jpg" class="w3-margin" alt="image" width="200px" height="200px" style="border-radius: 50%;">--%>
  ...
  <%--  <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false">
      ...
      <%--<button class="auto-style1" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="prev">
